...
Seq[Any](format.raw/*1.1*/("""<!-- Footer -->
		...
		<div class="container center" style="padding-bottom: 20px;">
					&copy; Data Science Infrastructure Lab, Department of Computer Science, Lyle School of Engineering, O’Donnell Data Science and Research Computing Institute, Southern Methodist University 2025
			<br>
			Contact us at: jiazhang&#64;smu.edu
